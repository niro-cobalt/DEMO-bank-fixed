...
(
    ...
    BAC_ACCNO                 VARCHAR2(9) NOT NULL WITH DEFAULT,
    BAC_ACCTYPE               VARCHAR2(1) NOT NULL WITH DEFAULT,
    ...
    BAC_ATM_ENABLED           VARCHAR2(2) NOT NULL WITH DEFAULT,
    BAC_ATM_DAY_LIMIT         DECIMAL(3,0) WITH DEFAULT,
    BAC_ATM_DAY_DTE           DATE WITH DEFAULT,
    BAC_ATM_DAY_AMT           DECIMAL(3,0) WITH DEFAULT,
    BAC_RP1_DAY               VARCHAR2(2) WITH DEFAULT,
    BAC_RP1_AMOUNT            DECIMAL(7,2) WITH DEFAULT,
    BAC_RP1_PID               VARCHAR2(5) WITH DEFAULT,
    BAC_RP1_ACCNO             VARCHAR2(9) WITH DEFAULT,
    BAC_RP1_LAST_PAY          DATE WITH DEFAULT,
    BAC_RP2_DAY               VARCHAR2(2) WITH DEFAULT,
    BAC_RP2_AMOUNT            DECIMAL(7,2) WITH DEFAULT,
    BAC_RP2_PID               VARCHAR2(5) WITH DEFAULT,
    BAC_RP2_ACCNO             VARCHAR2(9) WITH DEFAULT,
